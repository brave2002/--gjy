...
import com.xq.tmall.service.impl.HDFSServiceImpl;
...
public class ForeProductDetailsController extends BaseController {
    ...
    //    添加用户加入购物车信息到hdfs
    @RequestMapping("/ajaxAddHDFS")
    @ResponseBody
    public void addHDFS(@RequestParam String productId, String userId) throws IOException {
...
//        String shoppingLog="ShoppingLog{"+product.toProductString()+", "+user.toUserString()+"}";
//        System.out.println(shoppingLog);
        ShoppingLog shoppingLog=new ShoppingLog(product.getProduct_id(),product.getProduct_name(),
                product.getProduct_title(),product.getProduct_price(),product.getProduct_sale_price(),
                product.getProduct_create_date(),product.getProduct_category(),product.getProduct_sale_count(),
                product.getProduct_review_count(),product.getSetProduct_sale_co(),user.getUser_id(),user.getUser_name(),
                user.getUser_nickname(),user.getUser_password(),user.getUser_realname(),user.getUser_gender(),
                user.getUser_birthday(), user.getUser_address(), user.getUser_homeplace(), TimesUtil.getTimes());
        String line=JSON.toJSONString(shoppingLog);
        System.out.println(line);
        new HDFSServiceImpl().LogtoHDFS(line);
    }
