    ...
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-charts">
            ...
            <dd>
                ...
                <ul>
                    <li><a data-href="/charts/productSum" data-title="疯狂购物前十人" >疯狂购物前十人</a></li>
                </ul>
                <ul>
                    <li><a data-href="/charts/table6" data-title="商品类型分布" >商品类型分布</a></li>
                </ul>

                <ul>
                    <li><a data-href="/charts/table5" data-title="用户男女比例" >用户男女比例</a></li>
                </ul>
                <ul>
                    <li><a data-href="/charts/table3" data-title="男女每天消费比较" >男女每天消费比较</a></li>
                </ul>
                <ul>
                    <li><a data-href="/charts/table7" data-title="前两名消费喜好" >前两名消费喜好</a></li>
                </ul>
            </dd>
        </dl>
    </div>
